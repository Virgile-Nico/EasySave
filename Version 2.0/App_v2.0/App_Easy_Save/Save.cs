    ...
    class Save
    {
        ...
        public static void Full_Save(String source, String target, String SaveName, Boolean encrypt)
        {
            ...
            foreach (String file in Files)
            {
                ...
                //Call save function
                save_files(source, target, SaveName, file, encrypt);
            }
        ...
        private static void save_files(String source, String target, String SaveName, String file_source, Boolean encrypt)
        {
