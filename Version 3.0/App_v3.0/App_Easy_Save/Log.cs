...
namespace App_Easy_Save
{
    ...
    class Log_Daily
    {
        ...
        public async static void Log_Write(String SaveName, String Source, String target, String TimeElapsed)
        {
            try
            {
                mut.WaitOne();
                ...
                {
                    //write the data in the file
                    await using (StreamWriter LS = new StreamWriter(Log_Daily_Path + File_Name + "." + Log_extension))
                    {
                ...
                if (Log_extension == "XML")
                {
                    ...
                    for (int i = 0; i < read_daily_log.Length; i++)
                    {
                        ...
                        await using (StreamWriter LS = new StreamWriter(Log_Daily_Path + File_Name + "." + Log_extension, true))
                        {
