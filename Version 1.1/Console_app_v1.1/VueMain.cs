...
namespace Console_Vue
{
    public class VueMain
    {
        ...
        public static String Save_single(String Save_Name)
        {
            ...
            if(Target == "DEFAULT")
            {
                ...
                Save.save(Source, trgt, Type, Save_Name);
                return "Done";
            }
            ...
            {
                Save.save(Source, Target, Type, Save_Name);
                return "Done";
            }
        ...
        public static String Save_sequence(int lower_save, int upper_save)
        {
